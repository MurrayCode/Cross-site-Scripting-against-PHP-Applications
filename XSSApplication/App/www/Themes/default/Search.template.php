	...
	else
	{
		...
		for ($i = 0; $i < $max_boards; $i++)
		{
			...
			if (isset($temp_boards[$i]['id']))
				echo '
								<label for="brd' . $temp_boards[$i]['id'] . '" style="margin-left: ', $temp_boards[$i]['child_level'], 'ex;"><input type="checkbox" id="brd' . $temp_boards[$i]['id'] . '" name="brd[' . $temp_boards[$i]['id'] . ']" value="' . $temp_boards[$i]['id'] . '"', empty($context['search_params']['brd']) || in_array($temp_boards[$i]['id'], $context['search_params']['brd']) ? ' checked="checked"' : '', ' class="check" />
								' . $temp_boards[$i]['name'] . '</label>';
			elseif (isset($temp_boards[$i]['name']))
			...
			if (isset($temp_boards[$i + $max_boards]))
			{
				...
				if (isset($temp_boards[$i + $max_boards]['id']))
					echo '
								<label for="brd' . $temp_boards[$i + $max_boards]['id'] . '" style="margin-left: ', $temp_boards[$i + $max_boards]['child_level'], 'ex;"><input type="checkbox" id="brd' . $temp_boards[$i + $max_boards]['id'] . '" name="brd[' . $temp_boards[$i + $max_boards]['id'] . ']" value="' . $temp_boards[$i + $max_boards]['id'] . '"', empty($context['search_params']['brd']) || in_array($temp_boards[$i + $max_boards]['id'], $context['search_params']['brd']) ? ' checked="checked"' : '', ' class="check" />
								' . $temp_boards[$i + $max_boards]['name'] . '</label>';
				else
