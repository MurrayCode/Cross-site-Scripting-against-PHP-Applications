...
/**
 * A plugin setting item. A plugin setting item is basically a
 * name/value pair which extends item so it can inherit all items
 * functionality
 *
 ...
 */
class PluginSetting extends Item
{
	/**
	 ...
	 */
	function PluginSetting ($theItemId, $theOwner, $theParentId, $parent,
