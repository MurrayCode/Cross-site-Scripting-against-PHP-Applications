...
// +----------------------------------------------------------------------+
//
// $Id: PEAR.php 1063 2006-02-08 09:41:09Z barrel $
//
    ...
    */
                         ...
                         $userinfo = null)
    {
        if (isset($this) && is_subclass_of($this, 'PEAR_Error')) {
            $result =  $this->raiseError($message, $code, null, null, $userinfo);
        } else {
            $result = PEAR::raiseError($message, $code, null, null, $userinfo);
        }
		return $result;
    }
