 ...
 */
class NoteExplorerTreeDelegate extends TreeDelegate
{
        /**
         * Default constructor
         */
        function NoteExplorerTreeDelegate ($theConfiguration)
        {
