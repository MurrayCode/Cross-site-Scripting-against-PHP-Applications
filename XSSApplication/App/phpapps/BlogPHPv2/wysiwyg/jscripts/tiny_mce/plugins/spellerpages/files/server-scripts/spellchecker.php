...
$tinymce_content_css = $_POST['tinymcecontentcss'];
$aspell_prog = 'aspell';

//$aspell_prog = 'aspell';	//LINUX
$aspell_prog = '"http://www.blogphp.net/aspell/bin/aspell.exe"';	// WINDOWS
...
<?php if(!empty($tinymce_content_css)) echo '<link rel="stylesheet" type="text/css" href="'.$tinymce_content_css.'"/>'; ?>
