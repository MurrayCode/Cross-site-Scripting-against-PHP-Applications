...
<div class="gekko_editor">
  <form id="frm_category_editor" method="post" action="index.php?app=<?php echo $this->app_name ?>&action=savecategory" enctype="multipart/form-data" >
    <div id="gekko_dualpane_editor_sidebar">
      <h3><?php echo HTML_CATEGORY_EDITOR; ?></h3>
      <div id="gekko_dualpane_editor_sidebar_content">
      <p><input type="text" name="items_per_page" id="items_per_page"  value="<?php echo $category['items_per_page']; ?>" size="2" maxlength="5" /> <?php echo HTML_CATEGORY_DISPLAY_ITEMS_PERPAGE_IN_CATEGORY; ?></p>
    ...
    <div id="gekko_dualpane_editor_main">
      <div id="gekko_dualpane_editor_content">
        ...
        <label><?php echo TXT_SEO_SHORTCUT; ?><br />
          <input name="virtual_filename" id="virtual_filename"  type="text" class="gekko_editor_input validate-filename required" value="<?php echo $category['virtual_filename']; ?>" size="64" maxlength="254" />
        </label>
        <br />
        <br />
        <!-- tinymce -->
        ...
        <label><?php echo TXT_TEXT_DETAILS; ?><br />
          <textarea name="description" id="description"  style="width:100%"><?php echo $category['description']; ?></textarea>
        </label>
        <br />
