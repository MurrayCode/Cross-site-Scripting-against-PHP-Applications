...
<h3><?php echo USERS_USER_GROUPS; ?></h3>
<div id="gekko_admin_sidebar_content"></div>
</div>
<!-- end sidebar -->
<div id="gekko_admin_main">
<h3><?php echo USERS_USERS; ?></h3>
	<div class="gekko_admin_panel">
   <form id="gekko_admin_searchform" method="GET" action="#" onsubmit="return false" >
         <?php toolbar_button('new_document','user_add',USERS_NEW_ITEM,"index.php?app={$this->app_name}&action=newitem"); ?>
         <?php toolbar_button('new_folder','new_folder',USERS_NEW_GROUP,"index.php?app={$this->app_name}&action=newcategory"); ?>
