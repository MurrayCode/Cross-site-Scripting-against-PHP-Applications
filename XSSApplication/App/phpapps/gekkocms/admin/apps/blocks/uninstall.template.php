...
<div id="gekko_admin_main" >
  <h3><?php echo BLOCKS_BLOCK; ?>: <?php echo $filtered_app_name; ?></h3>
  ...
  <form method="post" action="index.php?app=<?php echo $this->app_name; ?>&action=uninstall&name=<?php echo $filtered_app_name; ?>" enctype="multipart/form-data">
    <label>
      ...
      <?php echo BLOCKS_CONFIRM_UNINSTALL; ?></label>
    <br/>
    <label>
      <input type="checkbox" name="database" />
      <?php echo BLOCKS_CONFIRM_DELETE_DATA; ?></label>
    <br/>
    <label>
      <input type="checkbox" name="everything" />
      <?php echo BLOCKS_CONFIRM_DELETE_EVERYTHING; ?></label>
    <br/>
    <br/>
  ...
  <p><?php echo BLOCKS_NOTIFIY_UNINSTALLED; ?></p>
  <?php else: ?>
