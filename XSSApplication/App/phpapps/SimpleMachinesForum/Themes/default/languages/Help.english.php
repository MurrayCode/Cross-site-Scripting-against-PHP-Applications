...
$helptxt['time_format'] = '<b>Time Format</b><br />
	...
	The conventions follow PHP\'s strftime function and are described as below (more details can be found at <a href="http://www.php.net/manual/function.strftime.php" target="_new">php.net</a>).<br />
	<br />
...
$helptxt['search_match_complete_words'] = 'This option limit search results to full words that match a users query. For example, if this option is disabled, a search term like \'here\' would match \'here\', \'there\', and \'hereafter\'. Enabling this option would limit search results to only match \'here\'.<br /><br />Please notice that enabling this option might slow down the search function, especially if the amount of messages is large.';
