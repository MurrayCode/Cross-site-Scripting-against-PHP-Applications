...
$txt['permissionhelp_who_view'] = 'Who\'s online shows all members that are currently online and what they are doing at that moment. This permission will only work if you also have enabled it in \'Features and Options\'. You can access the \'Who\'s Online\' screen by clicking the link in the \'Users Online\' section of the board index.';
...
$txt['permissionname_delete'] = 'Remove topics';
...
$txt['permissionname_delete_own'] = 'Own topic';
$txt['permissionname_delete_any'] = 'Any topics';
...
$txt['permissionname_remove_replies'] = 'Delete replies to own topics';
$txt['permissionhelp_remove_replies'] = 'This permission allows a user that started a topic to remove all replies to their topic.';
