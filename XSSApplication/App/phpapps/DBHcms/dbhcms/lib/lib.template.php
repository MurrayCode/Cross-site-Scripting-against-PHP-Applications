...
#                                                                                           #
#############################################################################################
# $Id: lib.template.php 61 2007-02-01 14:17:59Z kaisven $                                   #
#############################################################################################
...
#############################################################################################
	...
	dbhcms_p_register_file(realpath(__FILE__), 'template', 0.1);
...
class dbhcms_template
{
  ...
  * @return    void
  */
  function dbhcms_template($root = ".", $unknowns = "remove") {
    if ($this->debug & 4) {
  ...
  */
  function pparse($target, $varname, $append = false) {
	...
	$result = $this->finish($this->parse($target, $varname, $append));
    //print $result;
    return $result;
  }
