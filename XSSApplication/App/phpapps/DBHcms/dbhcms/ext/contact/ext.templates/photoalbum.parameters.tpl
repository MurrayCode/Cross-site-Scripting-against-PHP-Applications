	...
	#                                                                                           #
	#############################################################################################
	# $Id: photoalbum.parameters.tpl 61 2007-02-01 14:17:59Z kaisven $                          #
	#############################################################################################
			...
			<td>
				<table cellpadding="2" cellspacing="1" border="0" width="100%" align="center" style="border-color: #28538F; border-style: solid; border-width: 1px;">
					...
					<tr>
						<td>
							<table>
								<form method="post" name="photoalbumparam_new">
									<input type="hidden" name="todo" value="photoalbumNewParam" />
									<tr>
									...
									<tr>
										<td><input type="text" name="albumparam_insert_name"></td>
										<td>
											{str_photoalbumParamTypes}
										</td>
										<td><input type="text" name="albumparam_insert_description"></td>
