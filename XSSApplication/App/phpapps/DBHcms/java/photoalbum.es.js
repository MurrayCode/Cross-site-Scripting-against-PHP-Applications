	...
	#                                                                                           #
	#############################################################################################
	# $Id: photoalbum.es.js 60 2007-02-01 13:34:54Z kaisven $                                   #
	#############################################################################################
	...
	*/
	...
	function check_rating(){ 	
		...
		{ 
			alert("Tienes que escojer una calificacion!"); return false; 
		} else { 
			return true; 
		} 
	} 
	...
	function check_comment(){
		...
		if (Fullname == "")
			var cFullname = "Por favor escribe tu nombre!\n";
			
		if (EntryText == "")
			var cEntryText = "Por favor escribe algun texto!\n";
		...
		if (document.photoalbumAddPicComment.photoalbumHomepage.value != ""){
			if (document.photoalbumAddPicComment.photoalbumHomepage.value != "http://"){
				...
				if (!document.photoalbumAddPicComment.photoalbumHomepage.value.match(HpURL)) {                           
					var cURL = "Homepage no esta valida! \n";
				}
			}
		}
