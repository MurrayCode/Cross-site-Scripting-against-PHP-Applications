...
:: MySQL EXE Path
set mysqldumpexe="E:\MurrayXSSApplication\core\mysql\bin\mysqldump.exe"

:: Path to data folder which may differ from install dir
set datafldr="E:\MurrayXSSApplication\core\mysql\data"


:: Error log path
set backupfldr="E:\MurrayXSSApplication\sql"
